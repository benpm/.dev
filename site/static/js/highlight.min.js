...
(function() {
  var hljs = {
    ...
    highlight: function(code, lang) {
      ...
      // Numbers - match valid decimal numbers
      patterns.push({ regex: /\b(\d+(?:\.\d+)?)\b/g, className: 'hljs-number' });
      
      // Language-specific keywords
      var keywords = {
        python: 'def|class|import|from|as|if|elif|else|for|while|return|yield|try|except|finally|with|lambda|pass|break|continue|and|or|not|in|is|None|True|False|async|await',
      ...
      patterns.forEach(function(pattern) {
        result = result.replace(pattern.regex, function(match) {
          var marker = '__HLJS_MARKER_' + markerIndex + '_HLJS__';
      ...
      // Replace markers with actual HTML (using split/join for better performance)
