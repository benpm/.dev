  ...
  var hljs = {
    ...
    highlight: function(code, lang) {
      ...
      for (var marker in markers) {
        // Escape special regex characters in the marker for safe replacement
        var escapedMarker = marker.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
        var markerRegex = new RegExp(escapedMarker, 'g');
        result = result.replace(markerRegex, markers[marker]);
      }
